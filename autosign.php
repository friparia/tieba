...
<h1><font color="red">自动签到会获取您的很重要的信息(百度账号)，如果您不信任，可以自己下载源代码并实现，代码地址<a href="http://github.com/friparia/autosign">github.com/friparia/autosign</a></font></h1>
...
<form method="post" action="takebduss.php">
	需要签到的贴吧(以逗号隔开):<input name="kw" type="text" /></br>
